...
public int hanoiProblem2(int num,String left,String mid,String right){
    ...
    while(rS.size()!=num+1){
        ...
        step += fStackToStack(record,Action.RToL,Action.MToR,mS,rS,mid,right);
        step += fStackToStack(record,Action.MToL,Action.RToM,rS,mS,right,mid);
    }
    return step;
}

public static int fStackToStack(Action[] record,Action preNoAct,Action nowAct,Stack<Integer> fStack, Stack<Integer> tStack, String from, Stack to){
